module Lotus
  ...
  class Person
    ...
    many :following,     :in => :following_ids, :class_name => 'Lotus::Author'

    # Who is aggregating this feed.
    key  :followers_ids, Array
    many :followers,     :in => :followers_ids, :class_name => 'Lotus::Author'
    ...
    def deliver!(activity)
      ...
      author = Lotus::Author.find(:id => activity.author.id)
