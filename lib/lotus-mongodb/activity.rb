module Lotus
  class Activity
    ...
    def human_description
      ...
      when 'Author'
        author = Lotus::Author.find_by_id(self.actor_id)
      ...
      object_author = nil
      unless object.is_a? Lotus::Author
        object_author = Lotus::Author.find_by_id(activity.actor_id) if activity.actor_type == 'Author'
