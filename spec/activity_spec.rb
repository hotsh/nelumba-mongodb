...
describe Nelumba::Activity do
  ...
  describe "#parts_of_speech" do
    ...
    it "should yield the object when it is an Nelumba::Person" do
      author = Nelumba::Person.create(:nickname => "wilkie")
      activity = Nelumba::Activity.create(:object => author)

      activity.parts_of_speech[:object].nickname.must_equal "wilkie"
    end

    it "should yield the object when it is an Nelumba::Activity" do
      object_activity = Nelumba::Activity.create(:verb => :follow)
      activity = Nelumba::Activity.create(:object => object_activity)
    ...
    it "should yield the object owner as actor of embedded Nelumba::Activity" do
      author = Nelumba::Person.create(:nickname => "wilkie")
      object_activity = Nelumba::Activity.create(:verb  => :follow,
                                        :actor => author)
      activity = Nelumba::Activity.create(:object => object_activity)
    ...
    it "should yield the object owner as the embedded Nelumba::Person" do
      author = Nelumba::Person.create(:nickname => "wilkie")
      activity = Nelumba::Activity.create(:object => author)
    ...
    it "should yield the object owner as actor when object isn't embedded" do
      author = Nelumba::Person.create(:nickname => "wilkie")
      activity = Nelumba::Activity.create(:actor => author)
